...
def _():
    with tempfile.TemporaryDirectory() as directory:
        ...
        require_submodule(root)
        require(os.path.isfile(os.path.join(root, "info.json")), "info.json is absent")
        require(not os.path.exists(os.path.join(root, ".rblx-harness.json")), "legacy manifest was emitted")
