...
field positions; `void` fills an empty field. Schemas are listed below.
...
def emit_globals(updates_dir=None):
    ...
    lines = ["-- generated by api_dump --emit-globals; refresh explicitly after an API dump update", "return {"]
